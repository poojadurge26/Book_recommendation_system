...
if st.button('Show Recommendation'):
    ...
    with col1:
        st.text(recommended_books.loc[[0]['Book-Title']])
        st.text(recommended_books.loc[[0]['Image-URL-M']])
       
    with col2:
        st.text(recommended_books.loc[[1]['Book-Title']])
        st.text(recommended_books.loc[[1]['Image-URL-M']])

    with col3:
        st.text(recommended_books.loc[[2]['Book-Title']])
        st.text(recommended_books.loc[[2]['Image-URL-M']])
      
    with col4:
        st.text(recommended_books.loc[[3]['Book-Title']])
        st.text(recommended_books.loc[[3]['Image-URL-M']])
     
    with col5:
        st.text(recommended_books.loc[[4]['Book-Title']])
        st.text(recommended_books.loc[[4]['Image-URL-M']])
